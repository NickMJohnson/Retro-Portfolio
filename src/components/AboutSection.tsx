      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-5 gap-6">
          <div className="md:col-span-3 cyber-card space-y-4">
            ...
            />
            <WordReveal
              text="Outside of code I'm into rocketry, fixed-wing FPV, drone racing, guitar, and boxing. I care a lot about making things that people actually want to use."
              className="leading-relaxed text-base"
            />
          </div>
